  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 px-4 py-12 sm:px-6 lg:px-8 max-sm:py-2">
      <img
        src={indexImgSrc}
        alt=""
        className="absolute left-0 w-screen top-32 max-sm:hidden max-md:top-10"
      />
      <div className="absolute z-10 max-w-3xl text-white max-sm:static top-60 left-32 max-xl:top-40 max-xl:left-16 max-md:max-w-sm max-sm:mt-8 max-md:top-16">
